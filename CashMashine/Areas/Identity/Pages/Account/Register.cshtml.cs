...
namespace CashMashine.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!await _roleManager.RoleExistsAsync(WC.ManagerRole))
            {
                await _roleManager.CreateAsync(new IdentityRole(WC.ManagerRole));
                await _roleManager.CreateAsync(new IdentityRole(WC.CashierRole));
            }
            ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (User.IsInRole(WC.ManagerRole))
                    {
                        await _userManager.AddToRoleAsync(user, WC.ManagerRole);
                    }
                    else
                    {
                        await _userManager.AddToRoleAsync(user, WC.CashierRole);
                    }
